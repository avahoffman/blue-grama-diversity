...
#SBATCH --job-name=Bg_44
#SBATCH --mail-type=ALL
#SBATCH --mail-user=avamariehoffman@gmail.com
#SBATCH --error=error_bg44.%j.out
#SBATCH --output=out_bg44.%j.out
#SBATCH --qos=normal
...
bbduk.sh in=BgHq_1_3_1-118D_S451_L006_R1_001_T_Q.fastq ref=adaptors.fasta k=12 stats=stats44.txt out=BgHq_1_3_1-118D_S451_L006_R1_001_T_Q_A.fastq
