...
#SBATCH --job-name=Bg_64
#SBATCH --mail-type=ALL
#SBATCH --mail-user=avamariehoffman@gmail.com
#SBATCH --error=error_bg64.%j.out
#SBATCH --output=out_bg64.%j.out
#SBATCH --qos=normal
...
bbduk.sh in=BgHq_9_3_1-1110H_S471_L006_R1_001_T_Q.fastq ref=adaptors.fasta k=12 stats=stats64.txt out=BgHq_9_3_1-1110H_S471_L006_R1_001_T_Q_A.fastq
