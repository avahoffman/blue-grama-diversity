...
#SBATCH --job-name=Bg_9
#SBATCH --mail-type=ALL
#SBATCH --mail-user=avamariehoffman@gmail.com
#SBATCH --error=error_bg9.%j.out
#SBATCH --output=out_bg9.%j.out
#SBATCH --qos=normal
...
bbduk.sh in=Bgedge_1_3_1-114A_S416_L006_R1_001_T_Q.fastq ref=adaptors.fasta k=12 stats=stats09.txt out=Bgedge_1_3_1-114A_S416_L006_R1_001_T_Q_A.fastq
