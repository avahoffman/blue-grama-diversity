...
#SBATCH --error=error_bg24.%j.out
#SBATCH --output=out_bg24.%j.out
#SBATCH --qos=normal
...
bbduk.sh in=Bgedge_4_3_1-115B_S425_L006_R1_001_T_Q.fastq ref=adaptors.fasta k=12 stats=stats24.txt out=Bgedge_4_3_1-115B_S425_L006_R1_001_T_Q_A.fastq
