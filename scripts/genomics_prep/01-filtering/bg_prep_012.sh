...
#SBATCH --error=error_bg12.%j.out
#SBATCH --output=out_bg12.%j.out
#SBATCH --qos=normal
...
bbduk.sh in=Bgedge_10_1_1-117B_S441_L006_R1_001_T_Q.fastq ref=adaptors.fasta k=12 stats=stats12.txt out=Bgedge_10_1_1-117B_S441_L006_R1_001_T_Q_A.fastq
