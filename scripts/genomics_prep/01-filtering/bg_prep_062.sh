...
#SBATCH --job-name=Bg_62
#SBATCH --mail-type=ALL
#SBATCH --mail-user=avamariehoffman@gmail.com
#SBATCH --error=error_bg62.%j.out
#SBATCH --output=out_bg62.%j.out
#SBATCH --qos=normal
...
bbduk.sh in=BgHq_9_2_2-1110F_S469_L006_R1_001_T_Q.fastq ref=adaptors.fasta k=12 stats=stats62.txt out=BgHq_9_2_2-1110F_S469_L006_R1_001_T_Q_A.fastq
