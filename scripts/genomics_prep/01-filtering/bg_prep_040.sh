...
#SBATCH --error=error_bg40.%j.out
#SBATCH --output=out_bg40.%j.out
#SBATCH --qos=normal
...
bbduk.sh in=BgHq_1_1_1-117H_S447_L006_R1_001_T_Q.fastq ref=adaptors.fasta k=12 stats=stats40.txt out=BgHq_1_1_1-117H_S447_L006_R1_001_T_Q_A.fastq
