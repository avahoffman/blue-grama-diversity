...
#SBATCH --error=error_bg37.%j.out
#SBATCH --output=out_bg37.%j.out
#SBATCH --qos=normal
...
bbduk.sh in=Bgedge_9_3_1-116G_S438_L006_R1_001_T_Q.fastq ref=adaptors.fasta k=12 stats=stats37.txt out=Bgedge_9_3_1-116G_S438_L006_R1_001_T_Q_A.fastq
