...
#SBATCH --error=error_bg27.%j.out
#SBATCH --output=out_bg27.%j.out
#SBATCH --qos=normal
...
bbduk.sh in=Bgedge_4_6_1-115E_S428_L006_R1_001_T_Q.fastq ref=adaptors.fasta k=12 stats=stats27.txt out=Bgedge_4_6_1-115E_S428_L006_R1_001_T_Q_A.fastq
