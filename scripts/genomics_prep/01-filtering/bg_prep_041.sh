...
#SBATCH --error=error_bg41.%j.out
#SBATCH --output=out_bg41.%j.out
#SBATCH --qos=normal
...
bbduk.sh in=BgHq_1_1_2-118A_S448_L006_R1_001_T_Q.fastq ref=adaptors.fasta k=12 stats=stats41.txt out=BgHq_1_1_2-118A_S448_L006_R1_001_T_Q_A.fastq
