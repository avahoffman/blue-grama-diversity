...
#SBATCH --job-name=Bg_7
#SBATCH --mail-type=ALL
#SBATCH --mail-user=avamariehoffman@gmail.com
#SBATCH --error=error_bg7.%j.out
#SBATCH --output=out_bg7.%j.out
#SBATCH --qos=normal
...
bbduk.sh in=Bgedge_1_1_3-113G_S414_L006_R1_001_T_Q.fastq ref=adaptors.fasta k=12 stats=stats07.txt out=Bgedge_1_1_3-113G_S414_L006_R1_001_T_Q_A.fastq