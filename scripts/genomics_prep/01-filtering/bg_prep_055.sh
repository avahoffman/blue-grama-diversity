...
#SBATCH --job-name=Bg_55
#SBATCH --mail-type=ALL
#SBATCH --mail-user=avamariehoffman@gmail.com
#SBATCH --error=error_bg55.%j.out
#SBATCH --output=out_bg55.%j.out
#SBATCH --qos=normal
...
bbduk.sh in=BgHq_6_4_1-119G_S462_L006_R1_001_T_Q.fastq ref=adaptors.fasta k=12 stats=stats55.txt out=BgHq_6_4_1-119G_S462_L006_R1_001_T_Q_A.fastq
