...
#SBATCH --job-name=Bg_58
#SBATCH --mail-type=ALL
#SBATCH --mail-user=avamariehoffman@gmail.com
#SBATCH --error=error_bg58.%j.out
#SBATCH --output=out_bg58.%j.out
#SBATCH --qos=normal
...
bbduk.sh in=BgHq_7_2_1-1110B_S465_L006_R1_001_T_Q.fastq ref=adaptors.fasta k=12 stats=stats58.txt out=BgHq_7_2_1-1110B_S465_L006_R1_001_T_Q_A.fastq
