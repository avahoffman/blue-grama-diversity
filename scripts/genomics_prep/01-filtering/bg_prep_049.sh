...
#SBATCH --job-name=Bg_49
#SBATCH --mail-type=ALL
#SBATCH --mail-user=avamariehoffman@gmail.com
#SBATCH --error=error_bg49.%j.out
#SBATCH --output=out_bg49.%j.out
#SBATCH --qos=normal
...
bbduk.sh in=BgHq_4_1_1-119A_S456_L006_R1_001_T_Q.fastq ref=adaptors.fasta k=12 stats=stats49.txt out=BgHq_4_1_1-119A_S456_L006_R1_001_T_Q_A.fastq
