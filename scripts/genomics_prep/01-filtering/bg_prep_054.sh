...
#SBATCH --job-name=Bg_54
#SBATCH --mail-type=ALL
#SBATCH --mail-user=avamariehoffman@gmail.com
#SBATCH --error=error_bg54.%j.out
#SBATCH --output=out_bg54.%j.out
#SBATCH --qos=normal
...
bbduk.sh in=BgHq_6_3_1-119F_S461_L006_R1_001_T_Q.fastq ref=adaptors.fasta k=12 stats=stats54.txt out=BgHq_6_3_1-119F_S461_L006_R1_001_T_Q_A.fastq
