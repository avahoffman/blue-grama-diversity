...
## save info
write.csv(plot.dat,file="Analysis/genomics_output/DAPC_regional.csv")
...
ggsave(file="Analysis/genomics_output/figures/DAPC_regional.jpg",height = 3,width=4)
...
summ.dapc.assign
write.csv(summ.dapc.assign, file="Analysis/genomics_output/Population_probability_regional.csv")
...
pdf(file="Analysis/genomics_output/figures/Loci_loadings_reigonal.pdf",width=20,height=4)
loadingplot(loci.loadings, axis=2, thres=.004,main=NULL,xlab="Locus")
dev.off()
write.csv(loci.loadings, file="Analysis/genomics_output/Loci_loadings_regional.csv")
...
write.csv(long.dat,"Analysis/genomics_output/Structure_plot_data_regional.csv")
write.csv(posts,"Analysis/genomics_output/Structure_plot_data_regional_wide.csv")
ggplot(data=long.dat, aes(x=Var1,y=value, fill=pop)) +
  ...
  theme_void() +
  theme(legend.position = "none")
ggsave(file="Analysis/genomics_output/figures/structure_regional.jpg",height = 1.5,width=10)
