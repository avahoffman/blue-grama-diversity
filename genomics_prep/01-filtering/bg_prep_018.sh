...
#SBATCH --error=error_bg18.%j.out
#SBATCH --output=out_bg18.%j.out
#SBATCH --qos=normal
...
bbduk.sh in=Bgedge_2_1_1-114D_S419_L006_R1_001_T_Q.fastq ref=adaptors.fasta k=12 stats=stats18.txt out=Bgedge_2_1_1-114D_S419_L006_R1_001_T_Q_A.fastq
