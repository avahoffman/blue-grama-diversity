...
#SBATCH --job-name=Bg_60
#SBATCH --mail-type=ALL
#SBATCH --mail-user=avamariehoffman@gmail.com
#SBATCH --error=error_bg60.%j.out
#SBATCH --output=out_bg60.%j.out
#SBATCH --qos=normal
...
bbduk.sh in=BgHq_9_1_1-1110D_S467_L006_R1_001_T_Q.fastq ref=adaptors.fasta k=12 stats=stats60.txt out=BgHq_9_1_1-1110D_S467_L006_R1_001_T_Q_A.fastq
