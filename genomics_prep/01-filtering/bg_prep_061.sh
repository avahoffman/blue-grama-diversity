...
#SBATCH --job-name=Bg_61
#SBATCH --mail-type=ALL
#SBATCH --mail-user=avamariehoffman@gmail.com
#SBATCH --error=error_bg61.%j.out
#SBATCH --output=out_bg61.%j.out
#SBATCH --qos=normal
...
bbduk.sh in=BgHq_9_2_1-1110E_S468_L006_R1_001_T_Q.fastq ref=adaptors.fasta k=12 stats=stats61.txt out=BgHq_9_2_1-1110E_S468_L006_R1_001_T_Q_A.fastq
