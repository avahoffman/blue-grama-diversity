...
#SBATCH --job-name=Bg_47
#SBATCH --mail-type=ALL
#SBATCH --mail-user=avamariehoffman@gmail.com
#SBATCH --error=error_bg47.%j.out
#SBATCH --output=out_bg47.%j.out
#SBATCH --qos=normal
...
bbduk.sh in=BgHq_2_2_1-118G_S454_L006_R1_001_T_Q.fastq ref=adaptors.fasta k=12 stats=stats47.txt out=BgHq_2_2_1-118G_S454_L006_R1_001_T_Q_A.fastq
