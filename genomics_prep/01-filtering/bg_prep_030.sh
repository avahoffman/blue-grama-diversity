...
#SBATCH --error=error_bg30.%j.out
#SBATCH --output=out_bg30.%j.out
#SBATCH --qos=normal
...
bbduk.sh in=Bgedge_8_3_1-115H_S431_L006_R1_001_T_Q.fastq ref=adaptors.fasta k=12 stats=stats30.txt out=Bgedge_8_3_1-115H_S431_L006_R1_001_T_Q_A.fastq
