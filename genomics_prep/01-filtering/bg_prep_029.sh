...
#SBATCH --error=error_bg29.%j.out
#SBATCH --output=out_bg29.%j.out
#SBATCH --qos=normal
...
bbduk.sh in=Bgedge_8_2_1-115G_S430_L006_R1_001_T_Q.fastq ref=adaptors.fasta k=12 stats=stats29.txt out=Bgedge_8_2_1-115G_S430_L006_R1_001_T_Q_A.fastq
