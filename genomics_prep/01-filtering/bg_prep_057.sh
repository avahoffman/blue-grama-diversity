...
#SBATCH --job-name=Bg_57
#SBATCH --mail-type=ALL
#SBATCH --mail-user=avamariehoffman@gmail.com
#SBATCH --error=error_bg57.%j.out
#SBATCH --output=out_bg57.%j.out
#SBATCH --qos=normal
...
bbduk.sh in=BgHq_7_1_1-1110A_S464_L006_R1_001_T_Q.fastq ref=adaptors.fasta k=12 stats=stats57.txt out=BgHq_7_1_1-1110A_S464_L006_R1_001_T_Q_A.fastq
