...
#SBATCH --job-name=Bg_8
#SBATCH --mail-type=ALL
#SBATCH --mail-user=avamariehoffman@gmail.com
#SBATCH --error=error_bg8.%j.out
#SBATCH --output=out_bg8.%j.out
#SBATCH --qos=normal
...
bbduk.sh in=Bgedge_1_2_1-113H_S415_L006_R1_001_T_Q.fastq ref=adaptors.fasta k=12 stats=stats08.txt out=Bgedge_1_2_1-113H_S415_L006_R1_001_T_Q_A.fastq
