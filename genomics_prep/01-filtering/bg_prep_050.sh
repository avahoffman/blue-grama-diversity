...
#SBATCH --job-name=Bg_50
#SBATCH --mail-type=ALL
#SBATCH --mail-user=avamariehoffman@gmail.com
#SBATCH --error=error_bg50.%j.out
#SBATCH --output=out_bg50.%j.out
#SBATCH --qos=normal
...
bbduk.sh in=BgHq_4_2_1-119B_S457_L006_R1_001_T_Q.fastq ref=adaptors.fasta k=12 stats=stats50.txt out=BgHq_4_2_1-119B_S457_L006_R1_001_T_Q_A.fastq
