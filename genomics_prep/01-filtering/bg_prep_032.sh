...
#SBATCH --error=error_bg32.%j.out
#SBATCH --output=out_bg32.%j.out
#SBATCH --qos=normal
...
bbduk.sh in=Bgedge_8_5_1-116B_S433_L006_R1_001_T_Q.fastq ref=adaptors.fasta k=12 stats=stats32.txt out=Bgedge_8_5_1-116B_S433_L006_R1_001_T_Q_A.fastq
