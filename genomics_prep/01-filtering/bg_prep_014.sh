...
#SBATCH --error=error_bg14.%j.out
#SBATCH --output=out_bg14.%j.out
#SBATCH --qos=normal
...
bbduk.sh in=Bgedge_10_3_1-117D_S443_L006_R1_001_T_Q.fastq ref=adaptors.fasta k=12 stats=stats14.txt out=Bgedge_10_3_1-117D_S443_L006_R1_001_T_Q_A.fastq
