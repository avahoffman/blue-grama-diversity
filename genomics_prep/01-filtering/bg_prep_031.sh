...
#SBATCH --error=error_bg31.%j.out
#SBATCH --output=out_bg31.%j.out
#SBATCH --qos=normal
...
bbduk.sh in=Bgedge_8_4_1-116A_S432_L006_R1_001_T_Q.fastq ref=adaptors.fasta k=12 stats=stats31.txt out=Bgedge_8_4_1-116A_S432_L006_R1_001_T_Q_A.fastq
