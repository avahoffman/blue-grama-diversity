...
#SBATCH --error=error_bg19.%j.out
#SBATCH --output=out_bg19.%j.out
#SBATCH --qos=normal
...
bbduk.sh in=Bgedge_2_2_1-114E_S420_L006_R1_001_T_Q.fastq ref=adaptors.fasta k=12 stats=stats19.txt out=Bgedge_2_2_1-114E_S420_L006_R1_001_T_Q_A.fastq
