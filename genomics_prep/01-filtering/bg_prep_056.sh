...
#SBATCH --job-name=Bg_56
#SBATCH --mail-type=ALL
#SBATCH --mail-user=avamariehoffman@gmail.com
#SBATCH --error=error_bg56.%j.out
#SBATCH --output=out_bg56.%j.out
#SBATCH --qos=normal
...
bbduk.sh in=BgHq_6_5_1-119H_S463_L006_R1_001_T_Q.fastq ref=adaptors.fasta k=12 stats=stats56.txt out=BgHq_6_5_1-119H_S463_L006_R1_001_T_Q_A.fastq
