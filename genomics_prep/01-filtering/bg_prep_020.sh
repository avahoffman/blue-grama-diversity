...
#SBATCH --error=error_bg20.%j.out
#SBATCH --output=out_bg20.%j.out
#SBATCH --qos=normal
...
bbduk.sh in=Bgedge_2_3_1-114F_S421_L006_R1_001_T_Q.fastq ref=adaptors.fasta k=12 stats=stats20.txt out=Bgedge_2_3_1-114F_S421_L006_R1_001_T_Q_A.fastq
