...
#SBATCH --job-name=Bg_43
#SBATCH --mail-type=ALL
#SBATCH --mail-user=avamariehoffman@gmail.com
#SBATCH --error=error_bg43.%j.out
#SBATCH --output=out_bg43.%j.out
#SBATCH --qos=normal
...
bbduk.sh in=BgHq_1_2_1-118C_S450_L006_R1_001_T_Q.fastq ref=adaptors.fasta k=12 stats=stats43.txt out=BgHq_1_2_1-118C_S450_L006_R1_001_T_Q_A.fastq
