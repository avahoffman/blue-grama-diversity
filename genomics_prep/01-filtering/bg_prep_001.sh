...
#SBATCH --job-name=Bg_1
#SBATCH --mail-type=ALL
#SBATCH --mail-user=avamariehoffman@gmail.com
#SBATCH --error=error_bg1.%j.out
#SBATCH --output=out_bg1.%j.out
#SBATCH --qos=normal
...
bbduk.sh in=Bgcultivar_na_1_1-1112E_S476_L006_R1_001_T_Q.fastq ref=adaptors.fasta k=12 stats=stats01.txt out=Bgcultivar_na_1_1-1112E_S476_L006_R1_001_T_Q_A.fastq