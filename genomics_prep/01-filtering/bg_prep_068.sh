...
#SBATCH --job-name=Bg_68
#SBATCH --mail-type=ALL
#SBATCH --mail-user=avamariehoffman@gmail.com
#SBATCH --error=error_bg68.%j.out
#SBATCH --output=out_bg68.%j.out
#SBATCH --qos=normal
...
bbduk.sh in=BgHq_9_7_1-1111D_S475_L006_R1_001_T_Q.fastq ref=adaptors.fasta k=12 stats=stats68.txt out=BgHq_9_7_1-1111D_S475_L006_R1_001_T_Q_A.fastq
