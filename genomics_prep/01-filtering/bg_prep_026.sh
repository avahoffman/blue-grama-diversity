...
#SBATCH --error=error_bg26.%j.out
#SBATCH --output=out_bg26.%j.out
#SBATCH --qos=normal
...
bbduk.sh in=Bgedge_4_5_1-115D_S427_L006_R1_001_T_Q.fastq ref=adaptors.fasta k=12 stats=stats26.txt out=Bgedge_4_5_1-115D_S427_L006_R1_001_T_Q_A.fastq
