...
#SBATCH --error=error_bg15.%j.out
#SBATCH --output=out_bg15.%j.out
#SBATCH --qos=normal
...
bbduk.sh in=Bgedge_10_4_1-117E_S444_L006_R1_001_T_Q.fastq ref=adaptors.fasta k=12 stats=stats15.txt out=Bgedge_10_4_1-117E_S444_L006_R1_001_T_Q_A.fastq
