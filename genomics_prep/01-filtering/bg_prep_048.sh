...
#SBATCH --job-name=Bg_48
#SBATCH --mail-type=ALL
#SBATCH --mail-user=avamariehoffman@gmail.com
#SBATCH --error=error_bg48.%j.out
#SBATCH --output=out_bg48.%j.out
#SBATCH --qos=normal
...
bbduk.sh in=BgHq_2_3_1-118H_S455_L006_R1_001_T_Q.fastq ref=adaptors.fasta k=12 stats=stats48.txt out=BgHq_2_3_1-118H_S455_L006_R1_001_T_Q_A.fastq
