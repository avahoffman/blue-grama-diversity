...
#SBATCH --job-name=Bg_67
#SBATCH --mail-type=ALL
#SBATCH --mail-user=avamariehoffman@gmail.com
#SBATCH --error=error_bg67.%j.out
#SBATCH --output=out_bg67.%j.out
#SBATCH --qos=normal
...
bbduk.sh in=BgHq_9_6_1-1111C_S474_L006_R1_001_T_Q.fastq ref=adaptors.fasta k=12 stats=stats67.txt out=BgHq_9_6_1-1111C_S474_L006_R1_001_T_Q_A.fastq
