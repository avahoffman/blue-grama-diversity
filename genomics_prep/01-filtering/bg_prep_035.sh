...
#SBATCH --error=error_bg35.%j.out
#SBATCH --output=out_bg35.%j.out
#SBATCH --qos=normal
...
bbduk.sh in=Bgedge_9_1_3-116E_S436_L006_R1_001_T_Q.fastq ref=adaptors.fasta k=12 stats=stats35.txt out=Bgedge_9_1_3-116E_S436_L006_R1_001_T_Q_A.fastq
