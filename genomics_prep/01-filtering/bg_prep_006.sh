...
#SBATCH --job-name=Bg_6
#SBATCH --mail-type=ALL
#SBATCH --mail-user=avamariehoffman@gmail.com
#SBATCH --error=error_bg6.%j.out
#SBATCH --output=out_bg6.%j.out
#SBATCH --qos=normal
...
bbduk.sh in=Bgedge_1_1_2-113F_S413_L006_R1_001_T_Q.fastq ref=adaptors.fasta k=12 stats=stats06.txt out=Bgedge_1_1_2-113F_S413_L006_R1_001_T_Q_A.fastq
