...
#SBATCH --job-name=Bg_66
#SBATCH --mail-type=ALL
#SBATCH --mail-user=avamariehoffman@gmail.com
#SBATCH --error=error_bg66.%j.out
#SBATCH --output=out_bg66.%j.out
#SBATCH --qos=normal
...
bbduk.sh in=BgHq_9_5_1-1111B_S473_L006_R1_001_T_Q.fastq ref=adaptors.fasta k=12 stats=stats66.txt out=BgHq_9_5_1-1111B_S473_L006_R1_001_T_Q_A.fastq
