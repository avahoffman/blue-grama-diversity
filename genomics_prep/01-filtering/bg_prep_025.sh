...
#SBATCH --error=error_bg25.%j.out
#SBATCH --output=out_bg25.%j.out
#SBATCH --qos=normal
...
bbduk.sh in=Bgedge_4_4_1-115C_S426_L006_R1_001_T_Q.fastq ref=adaptors.fasta k=12 stats=stats25.txt out=Bgedge_4_4_1-115C_S426_L006_R1_001_T_Q_A.fastq
