...
#SBATCH --error=error_bg36.%j.out
#SBATCH --output=out_bg36.%j.out
#SBATCH --qos=normal
...
bbduk.sh in=Bgedge_9_2_1-116F_S437_L006_R1_001_T_Q.fastq ref=adaptors.fasta k=12 stats=stats36.txt out=Bgedge_9_2_1-116F_S437_L006_R1_001_T_Q_A.fastq
