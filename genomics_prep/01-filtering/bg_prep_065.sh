...
#SBATCH --job-name=Bg_65
#SBATCH --mail-type=ALL
#SBATCH --mail-user=avamariehoffman@gmail.com
#SBATCH --error=error_bg65.%j.out
#SBATCH --output=out_bg65.%j.out
#SBATCH --qos=normal
...
bbduk.sh in=BgHq_9_4_1-1111B_S472_L006_R1_001_T_Q.fastq ref=adaptors.fasta k=12 stats=stats65.txt out=BgHq_9_4_1-1111B_S472_L006_R1_001_T_Q_A.fastq
