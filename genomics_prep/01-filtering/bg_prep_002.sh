...
#SBATCH --job-name=Bg_2
#SBATCH --mail-type=ALL
#SBATCH --mail-user=avamariehoffman@gmail.com
#SBATCH --error=error_bg2.%j.out
#SBATCH --output=out_bg2.%j.out
#SBATCH --qos=normal
...
bbduk.sh in=Bgcultivar_na_2_1-1112F_S477_L006_R1_001_T_Q.fastq ref=adaptors.fasta k=12 stats=stats02.txt out=Bgcultivar_na_2_1-1112F_S477_L006_R1_001_T_Q_A.fastq
