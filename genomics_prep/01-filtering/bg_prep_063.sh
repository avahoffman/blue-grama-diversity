...
#SBATCH --job-name=Bg_63
#SBATCH --mail-type=ALL
#SBATCH --mail-user=avamariehoffman@gmail.com
#SBATCH --error=error_bg63.%j.out
#SBATCH --output=out_bg63.%j.out
#SBATCH --qos=normal
...
bbduk.sh in=BgHq_9_2_3-1110G_S470_L006_R1_001_T_Q.fastq ref=adaptors.fasta k=12 stats=stats63.txt out=BgHq_9_2_3-1110G_S470_L006_R1_001_T_Q_A.fastq
