...
#SBATCH --job-name=Bg_46
#SBATCH --mail-type=ALL
#SBATCH --mail-user=avamariehoffman@gmail.com
#SBATCH --error=error_bg46.%j.out
#SBATCH --output=out_bg46.%j.out
#SBATCH --qos=normal
...
bbduk.sh in=BgHq_2_1_1-118F_S453_L006_R1_001_T_Q.fastq ref=adaptors.fasta k=12 stats=stats46.txt out=BgHq_2_1_1-118F_S453_L006_R1_001_T_Q_A.fastq
