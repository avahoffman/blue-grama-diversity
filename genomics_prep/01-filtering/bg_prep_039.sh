...
#SBATCH --error=error_bg39.%j.out
#SBATCH --output=out_bg39.%j.out
#SBATCH --qos=normal
...
bbduk.sh in=Bgedge_9_5_1-117A_S440_L006_R1_001_T_Q.fastq ref=adaptors.fasta k=12 stats=stats39.txt out=Bgedge_9_5_1-117A_S440_L006_R1_001_T_Q_A.fastq
