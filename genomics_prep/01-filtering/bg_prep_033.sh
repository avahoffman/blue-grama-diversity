...
#SBATCH --error=error_bg33.%j.out
#SBATCH --output=out_bg33.%j.out
#SBATCH --qos=normal
...
bbduk.sh in=Bgedge_9_1_1-116C_S434_L006_R1_001_T_Q.fastq ref=adaptors.fasta k=12 stats=stats33.txt out=Bgedge_9_1_1-116C_S434_L006_R1_001_T_Q_A.fastq
