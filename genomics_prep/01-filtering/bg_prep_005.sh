...
#SBATCH --job-name=Bg_5
#SBATCH --mail-type=ALL
#SBATCH --mail-user=avamariehoffman@gmail.com
#SBATCH --error=error_bg5.%j.out
#SBATCH --output=out_bg5.%j.out
#SBATCH --qos=normal
...
bbduk.sh in=Bgedge_1_1_1-113E_S412_L006_R1_001_T_Q.fastq ref=adaptors.fasta k=12 stats=stats05.txt out=Bgedge_1_1_1-113E_S412_L006_R1_001_T_Q_A.fastq
