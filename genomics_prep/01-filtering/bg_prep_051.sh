...
#SBATCH --job-name=Bg_51
#SBATCH --mail-type=ALL
#SBATCH --mail-user=avamariehoffman@gmail.com
#SBATCH --error=error_bg51.%j.out
#SBATCH --output=out_bg51.%j.out
#SBATCH --qos=normal
...
bbduk.sh in=BgHq_4_3_1-119C_S458_L006_R1_001_T_Q.fastq ref=adaptors.fasta k=12 stats=stats51.txt out=BgHq_4_3_1-119C_S458_L006_R1_001_T_Q_A.fastq
