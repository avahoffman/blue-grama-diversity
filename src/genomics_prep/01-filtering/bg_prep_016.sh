...
#SBATCH --error=error_bg16.%j.out
#SBATCH --output=out_bg16.%j.out
#SBATCH --qos=normal
...
bbduk.sh in=Bgedge_10_5_1-117F_S445_L006_R1_001_T_Q.fastq ref=adaptors.fasta k=12 stats=stats16.txt out=Bgedge_10_5_1-117F_S445_L006_R1_001_T_Q_A.fastq
