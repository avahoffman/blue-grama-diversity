...
#SBATCH --job-name=Bg_45
#SBATCH --mail-type=ALL
#SBATCH --mail-user=avamariehoffman@gmail.com
#SBATCH --error=error_bg45.%j.out
#SBATCH --output=out_bg45.%j.out
#SBATCH --qos=normal
...
bbduk.sh in=BgHq_1_4_1-118E_S452_L006_R1_001_T_Q.fastq ref=adaptors.fasta k=12 stats=stats45.txt out=BgHq_1_4_1-118E_S452_L006_R1_001_T_Q_A.fastq
