...
#SBATCH --error=error_bg38.%j.out
#SBATCH --output=out_bg38.%j.out
#SBATCH --qos=normal
...
bbduk.sh in=Bgedge_9_4_1-116H_S439_L006_R1_001_T_Q.fastq ref=adaptors.fasta k=12 stats=stats38.txt out=Bgedge_9_4_1-116H_S439_L006_R1_001_T_Q_A.fastq
