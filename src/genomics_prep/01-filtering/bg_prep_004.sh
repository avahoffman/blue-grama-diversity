...
#SBATCH --job-name=Bg_4
#SBATCH --mail-type=ALL
#SBATCH --mail-user=avamariehoffman@gmail.com
#SBATCH --error=error_bg4.%j.out
#SBATCH --output=out_bg4.%j.out
#SBATCH --qos=normal
...
bbduk.sh in=Bgcultivar_na_4_1-1112H_S479_L006_R1_001_T_Q.fastq ref=adaptors.fasta k=12 stats=stats04.txt out=Bgcultivar_na_4_1-1112H_S479_L006_R1_001_T_Q_A.fastq