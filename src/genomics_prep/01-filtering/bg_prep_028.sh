...
#SBATCH --error=error_bg28.%j.out
#SBATCH --output=out_bg28.%j.out
#SBATCH --qos=normal
...
bbduk.sh in=Bgedge_8_1_1-115F_S429_L006_R1_001_T_Q.fastq ref=adaptors.fasta k=12 stats=stats28.txt out=Bgedge_8_1_1-115F_S429_L006_R1_001_T_Q_A.fastq
