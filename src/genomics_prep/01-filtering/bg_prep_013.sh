...
#SBATCH --error=error_bg13.%j.out
#SBATCH --output=out_bg13.%j.out
#SBATCH --qos=normal
...
bbduk.sh in=Bgedge_10_2_1-117C_S442_L006_R1_001_T_Q.fastq ref=adaptors.fasta k=12 stats=stats13.txt out=Bgedge_10_2_1-117C_S442_L006_R1_001_T_Q_A.fastq
