...
#SBATCH --error=error_bg23.%j.out
#SBATCH --output=out_bg23.%j.out
#SBATCH --qos=normal
...
bbduk.sh in=Bgedge_4_2_1-115A_S424_L006_R1_001_T_Q.fastq ref=adaptors.fasta k=12 stats=stats23.txt out=Bgedge_4_2_1-115A_S424_L006_R1_001_T_Q_A.fastq
