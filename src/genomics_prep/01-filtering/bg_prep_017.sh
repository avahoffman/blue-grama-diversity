...
#SBATCH --error=error_bg17.%j.out
#SBATCH --output=out_bg17.%j.out
#SBATCH --qos=normal
...
bbduk.sh in=Bgedge_10_6_1-117G_S446_L006_R1_001_T_Q.fastq ref=adaptors.fasta k=12 stats=stats17.txt out=Bgedge_10_6_1-117G_S446_L006_R1_001_T_Q_A.fastq
