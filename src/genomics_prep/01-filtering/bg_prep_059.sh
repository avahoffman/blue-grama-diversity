...
#SBATCH --job-name=Bg_59
#SBATCH --mail-type=ALL
#SBATCH --mail-user=avamariehoffman@gmail.com
#SBATCH --error=error_bg59.%j.out
#SBATCH --output=out_bg59.%j.out
#SBATCH --qos=normal
...
bbduk.sh in=BgHq_7_3_1-1110C_S466_L006_R1_001_T_Q.fastq ref=adaptors.fasta k=12 stats=stats59.txt out=BgHq_7_3_1-1110C_S466_L006_R1_001_T_Q_A.fastq
