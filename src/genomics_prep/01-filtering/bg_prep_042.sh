...
#SBATCH --job-name=Bg_42
#SBATCH --mail-type=ALL
#SBATCH --mail-user=avamariehoffman@gmail.com
#SBATCH --error=error_bg42.%j.out
#SBATCH --output=out_bg42.%j.out
#SBATCH --qos=normal
...
bbduk.sh in=BgHq_1_1_3-118B_S449_L006_R1_001_T_Q.fastq ref=adaptors.fasta k=12 stats=stats42.txt out=BgHq_1_1_3-118B_S449_L006_R1_001_T_Q_A.fastq
