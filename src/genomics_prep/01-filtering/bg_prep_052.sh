...
#SBATCH --job-name=Bg_52
#SBATCH --mail-type=ALL
#SBATCH --mail-user=avamariehoffman@gmail.com
#SBATCH --error=error_bg52.%j.out
#SBATCH --output=out_bg52.%j.out
#SBATCH --qos=normal
...
bbduk.sh in=BgHq_6_1_1-119D_S459_L006_R1_001_T_Q.fastq ref=adaptors.fasta k=12 stats=stats52.txt out=BgHq_6_1_1-119D_S459_L006_R1_001_T_Q_A.fastq
