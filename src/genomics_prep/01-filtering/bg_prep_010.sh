...
#SBATCH --error=error_bg10.%j.out
#SBATCH --output=out_bg10.%j.out
#SBATCH --qos=normal
...
bbduk.sh in=Bgedge_1_4_1-114B_S417_L006_R1_001_T_Q.fastq ref=adaptors.fasta k=12 stats=stats10.txt out=Bgedge_1_4_1-114B_S417_L006_R1_001_T_Q_A.fastq
