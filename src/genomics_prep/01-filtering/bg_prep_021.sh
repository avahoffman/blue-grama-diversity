...
#SBATCH --error=error_bg21.%j.out
#SBATCH --output=out_bg21.%j.out
#SBATCH --qos=normal
...
bbduk.sh in=Bgedge_2_4_1-114G_S422_L006_R1_001_T_Q.fastq ref=adaptors.fasta k=12 stats=stats21.txt out=Bgedge_2_4_1-114G_S422_L006_R1_001_T_Q_A.fastq
