...
#SBATCH --error=error_bg11.%j.out
#SBATCH --output=out_bg11.%j.out
#SBATCH --qos=normal
...
bbduk.sh in=Bgedge_1_5_1-114C_S418_L006_R1_001_T_Q.fastq ref=adaptors.fasta k=12 stats=stats11.txt out=Bgedge_1_5_1-114C_S418_L006_R1_001_T_Q_A.fastq
